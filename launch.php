...
<body>
  <form action="launching.php" method="post">
    ...
    截止時間： <input type="text" id="timepicker" name="endDate"><br>
    ...
    商品單價： $ <input type="number" name="quantity" min="1"> 起<br>
    團購說明：<br><textarea name="description" cols="30" rows="10"></textarea><br>
    <input type="submit">
  </form>
  
  <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.12.2/jquery.min.js"></script>
  <script src="http://momentjs.com/downloads/moment.min.js"></script> <!-- 有.js 跟 .min.js 在local端 -->
  <script src="js/bootstrap-material-datetimepicker.js"></script>
  <script>
	  $(function() {
		$('#timepicker').bootstrapMaterialDatePicker({ format : 'YYYY-MM-DD HH:mm', minDate : new Date() });
	  });
  </script>
</body>
</html>